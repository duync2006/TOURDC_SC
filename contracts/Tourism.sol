...
// error InvalidVP(address Address, uint8 VotingPower);
...
//     // Reward
//     mapping(bytes32 => bool) public isDivideReward;
...
//     function getAllReviewsOfTourist(address touristAddress)
//         public
//         view
...
//                 if (curator.VP < 2 && curator.VP > 100) {
//           revert InvalidVP({
//             Address: msg.sender,
//             VotingPower: curator.VP
//           });
//         }
...
//         uint256 voteNum = reviewByID[postID].upvoteNum;
...
//             uint256 curatorVP = upvotes[i].curatorREP;
